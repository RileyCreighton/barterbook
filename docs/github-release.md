...
The public [repository](https://github.com/RileyCreighton/barterbook) and [live demo](https://barterbook-devnet.rileycreighton.workers.dev) include the [verified browser basket and three-way match](browser-execution-evidence.md). Use [the testing guide](judging-guide.md) for hands-on judging. The sections below describe repository setup and operator deployment.
