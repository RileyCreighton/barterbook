...
| 2:35–2:50 | **Current state.** “The site, source and hosted SDK receipts are public. A Solflare network warning blocks browser settlement, despite verified Devnet blockhash origin. The Free CPU gate is also unmet; no paid upgrade was made.” Point to the evidence ledger and setup documentation. |
