...
**Live Devnet-configured prototype:** [open the no-wallet guide](https://barterbook-devnet.rileycreighton.workers.dev/#/walkthrough), [source](https://github.com/RileyCreighton/barterbook), [242 passing CI tests for deployed build `9356ad6`](https://github.com/RileyCreighton/barterbook/actions/runs/36121726045).
